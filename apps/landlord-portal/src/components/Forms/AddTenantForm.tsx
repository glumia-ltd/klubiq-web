...
// 		useState<AddTenantFormValues>(defaultValues);
...
// 			}
// 			let response;
// 			if (leaseAndUnitDetails && leaseAndUnitDetails.leaseId) {
// 				response = await addNewTenantToLease(requestData).unwrap();
// 			} else {
// 				requestData = omit(requestData, ['leaseId']);
// 				response = await addNewTenantWithoutLease(requestData).unwrap();
// 			}
...
// 						message: (error as any)?.message || screenMessages.tenant.add.error,
// 					}),
// 					severity: 'error',
// 					isOpen: true,
// 					duration: 10000,
